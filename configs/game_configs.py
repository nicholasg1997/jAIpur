...
REWARD_SCALING_FACTOR_SELL_POINTS = 0.01
K1_SELLABLE_FACTOR = 0.0
K2_UNSELLABLE_FACTOR = 0.0
...
REWARD_FACTOR_DELTA_HAND_HEURISTIC = 0.0
BASE_REWARD_ACTION_SUCCESS = 0.0  # 0.02

PENALTY_INVALID_ACTION = -1.5
VALID_N_FOR_N_EXCHANGE_CONSTRUCTION_BONUS = 0.001  # 0.25
REWARD_FACTOR_CAMEL_TAKEN = 0.0
BASE_REWARD_FREE_SINGLE_TAKE_SUCCESS = 0.0  # 0.01
BASE_REWARD_N_FOR_N_EXCHANGE_SUCCESS = 0.0  # 0.01
ACTION_COST = 0.0001
